...
public interface ConfigurableComponent {
     ...
     *
     * <p>
     * When NiFi is restarted, this method will be called for all properties.
     * I.e. including when the value is default as well as for each 'dynamic' property
     * that has been added. <code>oldValue</code> will be <code>null</code>. If it is undesirable for your use case
