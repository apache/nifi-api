...
public class StandardValidators {
    ...
    public static final Validator TIME_PERIOD_VALIDATOR = new Validator() {
        private static final Pattern TIME_DURATION_PATTERN = Pattern.compile(DurationFormat.TIME_DURATION_REGEX);
    ...
    public static final Validator DATA_SIZE_VALIDATOR = new Validator() {
        private static final Pattern DATA_SIZE_PATTERN = Pattern.compile(DataUnit.DATA_SIZE_REGEX);
